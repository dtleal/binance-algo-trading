...
bots: redis ## Start all validated bots with optimal configurations (auto-reads from trader/config.py)
	...
	@echo ""
	@echo "$(BLUE)Active Strategies (21 bots):$(NC)"
