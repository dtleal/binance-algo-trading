...
# 🧪 BACKTESTING
# ══════════════════════════════════════════════════════════════════════════════
# Os scripts Python legacy (backtest_detail*.py, backtest_sweep.py etc.) foram
# substituídos pelo binário Rust unificado: `make sweep` (grid) e `make detail`
# (1 combo + chart HTML). Veja seção "Unified Rust sweep" abaixo.
